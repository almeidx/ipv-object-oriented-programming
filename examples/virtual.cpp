...
public:
	...
	virtual void show() { cout << "Vehicle: " << brand << " " << year << endl; }

	int get_year() { return year; }

	string get_brand() { return brand; }

	virtual string get_type() { return "Vehicle"; }
};
...
public:
	...
	void show() { cout << "LargeVehicle: " << get_brand() << " " << get_year() << " " << weight << endl; }

	string get_type() { return "LargeVehicle"; }
};
...
public:
	LightVehicle() : Vehicle() { passengers = 0; }

	LightVehicle(string _brand, int _year, int _passengers) : Vehicle(_brand, _year) { passengers = _passengers; }

	void show() { cout << "LightVehicle: " << get_brand() << " " << get_year() << " " << passengers << endl; }
};
